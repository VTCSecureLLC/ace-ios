...
- (void)addSipField:(NSString *)address {
    ...
    [self removeEntry:[self tableView] path:[NSIndexPath indexPathForRow:0 inSection:ContactSections_Sip] animated:NO];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSRange sipRange = [value rangeOfString:@"sip:"];
    if (sipRange.location != NSNotFound) {
        value = [value substringFromIndex:sipRange.length];
    }
